#ifndef HALIDE__box_filter_h
#define HALIDE__box_filter_h
#include <stdint.h>
...
int box_filter(struct halide_buffer_t *_p1_buffer, int32_t _p0, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int box_filter_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *box_filter_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return box_filter_metadata;
}
#endif


int box_filter_old_buffer_t(struct buffer_t *_p1, int32_t _p0, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
