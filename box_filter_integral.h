#ifndef HALIDE__box_filter_integral_h
#define HALIDE__box_filter_integral_h
#include <stdint.h>
...
int box_filter_integral(struct halide_buffer_t *_p1_buffer, uint8_t _p0, struct halide_buffer_t *_box_filter_integral_buffer) HALIDE_FUNCTION_ATTRS;
int box_filter_integral_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *box_filter_integral_metadata() HALIDE_FUNCTION_ATTRS;
...
inline int (*HALIDE_GET_STANDARD_ARGV_FUNCTION())(void**) {
    return box_filter_integral_argv;
}
#endif
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return box_filter_integral_metadata;
}
#endif


int box_filter_integral_old_buffer_t(struct buffer_t *_p1, uint8_t _p0, struct buffer_t *_box_filter_integral) HALIDE_FUNCTION_ATTRS;
